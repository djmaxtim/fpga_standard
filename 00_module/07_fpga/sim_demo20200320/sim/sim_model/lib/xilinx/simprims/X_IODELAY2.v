// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/stan/X_IODELAY2.v,v 1.32 2011/01/06 21:27:03 robh Exp $
///////////////////////////////////////////////////////
...
module X_IODELAY2 (
  ...
  parameter integer SIM_IDATAIN_INDELAY = 110; 
  parameter integer SIM_ODATAIN_INDELAY = 110; 
...
//-----------------------------------------------------------------------------
  ...
  localparam MODULE_NAME = "X_IODELAY2";
...
//-----------------------------------------------------------------------------
  ...
  buf B_CAL (CAL_IN, CAL);
  buf B_CE (CE_IN, CE);
  buf B_IDATAIN (IDATAIN_IN, IDATAIN);
  buf B_INC (INC_IN, INC);
  ...
  specify
    $setuphold (posedge CLK, negedge CAL, 0:0:0, 0:0:0, notifier,,, CLK_IN, CAL_IN);
    $setuphold (posedge CLK, negedge CE, 0:0:0, 0:0:0, notifier,,, CLK_IN, CE_IN);
    $setuphold (posedge CLK, negedge INC, 0:0:0, 0:0:0, notifier,,, CLK_IN, INC_IN);
    $setuphold (posedge CLK, negedge RST, 0:0:0, 0:0:0, notifier,,, CLK_IN, RST_IN);
    $setuphold (posedge CLK, posedge CAL, 0:0:0, 0:0:0, notifier,,, CLK_IN, CAL_IN);
    $setuphold (posedge CLK, posedge CE, 0:0:0, 0:0:0, notifier,,, CLK_IN, CE_IN);
    $setuphold (posedge CLK, posedge INC, 0:0:0, 0:0:0, notifier,,, CLK_IN, INC_IN);
