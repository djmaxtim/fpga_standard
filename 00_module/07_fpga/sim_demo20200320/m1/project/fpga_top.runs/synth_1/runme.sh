...
HD_PWD='G:/00_module/07_fpga/sim_demo20200320/m1/project/fpga_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCIE_IF_GX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCIE_IF_GX.tcl
