...
add wave -noupdate -divider (U02_COM_REG)
add wave -noupdate -format Logic -radix hexadecimal /tb_top/U_FPGA_TOP_SIM/U01_LBUS_TOP/U02_COM_REG/*

add wave -noupdate -divider (U03_BRAM_IF)
add wave -noupdate -format Logic -radix hexadecimal /tb_top/U_FPGA_TOP_SIM/U01_LBUS_TOP/U03_BRAM_IF/*

add wave -noupdate -divider (U04_DRAM_RD_IF)
add wave -noupdate -format Logic -radix hexadecimal /tb_top/U_FPGA_TOP_SIM/U01_LBUS_TOP/U04_DRAM_RD_IF/*

add wave -noupdate -divider (U05_DRAM_WR_IF)
add wave -noupdate -format Logic -radix hexadecimal /tb_top/U_FPGA_TOP_SIM/U01_LBUS_TOP/U05_DRAM_WR_IF/*
