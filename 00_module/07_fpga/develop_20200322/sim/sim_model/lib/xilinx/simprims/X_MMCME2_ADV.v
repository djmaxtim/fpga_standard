// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/fuji/X_MMCME2_ADV.v,v 1.13.8.2 2011/06/10 18:56:57 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
...
module X_MMCME2_ADV (
  ...
  real clk0_sdivide;
  integer clk0_sdivide_int, clk0_sfrac, clk0_sevent_part_high;
...
//  reg [2:0] clk0pmf_sel, clk0pmr_sel;
  ...
  initial begin
    ...
    if ($realtime == 0) begin
      $display ("Simulator Resolution Error : Simulator resolution is set to a value greater than 1 ps.");
	   $display ("In order to simulate the X_MMCME2_ADV, the simulator resolution must be set to 1ps or smaller.");
	   $finish;
    end
  end
  ...
  initial begin
    case (STARTUP_WAIT)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute STARTUP_WAIT on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE.", STARTUP_WAIT);
        $finish;
      end
    endcase
    ...
    case (BANDWIDTH)
      ...
      "LOW" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute BANDWIDTH on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are OPTIMIZED, HIGH, or LOW.", BANDWIDTH);
        $finish;
      end
    endcase
    ...
    case (CLKFBOUT_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKFBOUT_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKFBOUT_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT0_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT0_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT0_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT1_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT1_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT1_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT2_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT2_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT2_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT3_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT3_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT3_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT4_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT4_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT4_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT5_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT5_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT5_USE_FINE_PS);
        $finish;
      end
    endcase
    ...
    case (CLKOUT6_USE_FINE_PS)
      ...
      "TRUE" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT6_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT6_USE_FINE_PS);
        $finish;
      end
    endcase
...
//      "TRUE" : clkin_hold_f = 1;
//      default : begin
//        $display("Attribute Syntax Error : The Attribute CLOCK_HOLD on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLOCK_HOLD);
//        $finish;
//      end
//    endcase
    ...
    case (CLKOUT4_CASCADE)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute CLKOUT4_CASCADE on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.", CLKOUT4_CASCADE);
        $finish;
      end
    endcase
    ...
    case (COMPENSATION)
      ...
      "INTERNAL" : ;
      default : begin
        $display("Attribute Syntax Error : The Attribute COMPENSATION on X_MMCME2_ADV instance %m is set to %s.  Legal values for this attribute are ZHOLD, BUF_IN, EXTERNAL, or INTERNAL.", COMPENSATION);
        $finish;
      end
    endcase
...
//        $display("Attribute Syntax Error : The Attribute CLKFBOUT_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  This attribute should be set to FALSE when CLKFBOUT_MULT_F has fraction part.", CLKFBOUT_USE_FINE_PS);
//        $finish;
//      end
//    else
        clkfb_fps_en = 1;
...
//        $display("Attribute Syntax Error : The Attribute CLKOUT0_USE_FINE_PS on X_MMCME2_ADV instance %m is set to %s.  This attribute should be set to FALSE when CLKOUT0_DIVIDE has fraction part.", CLKOUT0_USE_FINE_PS);
//        $finish;
//      end
 //     else
        clk0_fps_en = 1;
    ...
    if (CLKOUT0_DIVIDE_F > 1.0000 && CLKOUT0_DIVIDE_F < 2.0000)
      $display("Attribute Syntax Error : The Attribute CLKOUT0_DIVIDE_F on X_MMCME2_ADV instance %m is set to %f.  Values in range of greater than 1 and less than 2 are not allowed.", CLKOUT0_DIVIDE_F);
...
//        $display("Attribute Syntax Error : The Attribute CLKOUT0_PHASE on X_MMCME2_ADV instance %m is set to %f.  This attribute should be set to 0.0 when CLKOUT0_DIVIDE_F has fraction part.", CLKOUT0_PHASE);
//        $finish;
//       end
    ...
    if (clk0_frac_en == 0)
       ...
       if (CLKOUT0_DUTY_CYCLE != 0.5) begin
        $display("Attribute Syntax Error : The Attribute CLKOUT0_DUTY_CYCLE on X_MMCME2_ADV instance %m is set to %f.  This attribute should be set to 0.5 when CLKOUT0_DIVIDE_F has fraction part.", CLKOUT0_DUTY_CYCLE);
        $finish;
       end
...
//        $display("Attribute Syntax Error : The Attribute CLKFBOUT_PHASE on X_MMCME2_ADV instance %m is set to %f.  This attribute should be set to 0.0 when CLKFBOUT_MULT_F has fraction part.", CLKFBOUT_PHASE);
//        $finish;
//      end
...
//  else
  ...
  case (clkfb_div_fint)
    ...
    if (clkfb_frac_en == 1) begin
      ...
      tmp_string = "CLKFBOUT_PHASE";
      clkout_dly_real_cal (clkfbm1_dly, clkfbm1pm_sel, CLKFBOUT_MULT_F, CLKFBOUT_PHASE, tmp_string);
    end
    else begin
      tmp_string = "CLKFBOUT_PHASE";
    ...
    if (clk0_frac_en == 1) begin
      ...
      tmp_string = "CLKOUT0_PHASE";
      clkout_dly_real_cal (clkout0_dly, clk0pm_sel, CLKOUT0_DIVIDE_F, CLKOUT0_PHASE, tmp_string);
    end
    else begin
      tmp_string = "CLKOUT0_PHASE";
  ...
  if ($time > 1 && rst_in === 0 && (clkinsel_tmp === 0 || clkinsel_tmp === 1)) begin
      $display("Input Error : Input clock can only be switched when RST=1. CLKINSEL on X_MMCME2_ADV instance %m at time %t changed when RST low, which should change at RST high.", $time);
      $finish;
  end
  ...
  always @(posedge dclk_in or posedge GSR)
    if (GSR == 1) begin
      ...
      if (den_in == 1) begin
        ...
        if (drp_lock == 1) begin
          $display(" Warning : DEN is high at X_MMCME2_ADV instance %m at time %t. Need wait for DRDY signal before next read/write operation through DRP. ", $time);
        end
        else begin
          drp_lock <= 1;
          daddr_lat <= daddr_in;
        ...
        if (valid_daddr && ( daddr_in == 7'b1110100 || daddr_in == 7'b1001111 ||
          ...
          $display(" Warning : Address DADDR=%b is unsupported at X_MMCME2_ADV instance %m at time %t.  ",  DADDR, $time);
        end
          ...
          (daddr_in >= 7'b0000110 && daddr_in <= 7'b0010110))) begin
             ...
             if (daddr_in == 7'b0010100) begin
               ...
               if (clkfbtmp_divi > M_MAX || (clkfbtmp_divi < M_MIN))
                  $display(" Input Error : DI at Address DADDR=%b is %h at X_MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %h and over the range of %f to %f.",  daddr_in, di_in, clkfbtmp_divi, $time, M_MIN, M_MAX);
            end
             ...
             if (daddr_in == 7'b0010110) begin
               ...
               if (clkind_divi > D_MAX || (clkind_divi < 1 && clkind_nocnti == 0))
                  $display(" Input Error : DI at Address DADDR=%b is %h at X_MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %d and over the range of 1 to %d.",  daddr_in, di_in, clkind_divi, $time, D_MAX);
            end
          end
          else begin
                  $display(" Error : RST is low at X_MMCME2_ADV instance %m at time %t. RST need to be high when change X_MMCME2_ADV paramters through DRP. ", $time);
          end
        end //DWE
    end  //DEN
    if ( drp_lock == 1) begin
  ...
  always @(posedge clkinstopped_out or posedge rst_in)
    if (rst_in)
     ...
     if (clkin_hold_f == 1) begin
       ...
       if (clkinsel_in == 1)
        $display(" Error : input CLKIN1 of X_MMCME2_ADV on instance %m is stopped. Reset is required for X_MMCME2_ADV whether stopped input clock comes back or not.");
       else
        $display(" Error : input CLKIN2 of X_MMCME2_ADV on instance %m is stopped. Reset is required for X_MMCME2_ADV whether stopped input clock comes back or not.");
     end
    end
...
//          val_tmp = period_vco_mf;
  ...
  always @(posedge psclk_in or posedge rst_in)
    if (rst_in) begin
     ...
     if (psen_in) begin
       if (psen_w == 1)
        $display(" Error : PSEN on X_MMCME2_ADV instance %m is active more than 1 PSCLK period at time %t. PSEN must be active for only one PSCLK period.", $time);

       psen_w <= 1;
       if (ps_lock == 1) 
        $display(" Warning : Please wait for PSDONE signal on X_MMCME2_ADV instance %m at time %t before adjusting the Phase Shift.", $time);
...
//      deassign clkfb_tst;
  ...
  always @(fb_delay)
    if (rst_in==0 && (fb_delay/1000.0 > fb_delay_max)) begin
      $display("Warning : The feedback delay on X_MMCME2_ADV instance %m at time %t is %f ns. It is over the maximun value %f ns.", $time, fb_delay / 1000.0, fb_delay_max);
    end
...
//  integer clkdiv;
  ...
  begin
    ...
    if (clkout_dly_tmp > 63) begin
      $display(" Warning : Attribute %s of X_MMCME2_ADV on instance %m is set to %f. Required phase shifting can not be reached since it is over the maximum phase shifting ability of X_MMCME2_ADV", clk_ps_name, clk_ps);
    ...
    if (((clk_ps_rl- clk_ps) > 0.001) || ((clk_ps_rl- clk_ps) < -0.001))
      $display(" Warning : Attribute %s of X_MMCME2_ADV on instance %m is set to %f. Real phase shifting is %f. Required phase shifting can not be reached.", clk_ps_name, clk_ps, clk_ps_rl);
  ...
  begin
    if ( para_in < range_low || para_in > range_high) begin
      $display("Attribute Syntax Error : The Attribute %s on X_MMCME2_ADV instance %m is set to %d.  Legal values for this attribute are %d to %d.", para_name, para_in, range_low, range_high);
      $finish;
    end
  ...
  begin
    if ( para_in < range_low || para_in > range_high) begin
      $display("Attribute Syntax Error : The Attribute %s on X_MMCME2_ADV instance %m is set to %f.  Legal values for this attribute are %f to %f.", para_name, para_in, range_low, range_high);
      $finish;
    end
  ...
  begin
    if (di_in_tmp[12] != 1) begin
      $display(" Error : X_MMCME2_ADV on instance %m input DI is %h at address DADDR=%b at time %t. The bit 12 need to be set to 1 .", di_in_tmp, daddr_in_tmp, $time); 
    end
