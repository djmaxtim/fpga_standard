...
// =============================================================================
 ...
 wire        [  11:0]                s_DRAM0_WR_SIZE                         ;//(s)  [ 12]  SDRAM write size
 ...
 wire        [  31:0]                s_DRAM0_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  11:0]                s_DRAM1_WR_SIZE                         ;//(s)  [ 12]  SDRAM write size
 ...
 wire        [  31:0]                s_DRAM1_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  31:0]                s_DRAM2_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  31:0]                s_DRAM3_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  31:0]                s_DRAM4_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  31:0]                s_DRAM5_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire        [  31:0]                s_DRAM6_WR_DATA                         ;//(s)  [ 32]  SDRAM write data
 ...
 wire                                s_USB_REG_WR_REQ                        ;
 wire                                s_USB_REG_WR_ACK                        ;
 wire        [  31:0]                s_USB_REG_WR_DATA                       ;
 wire                                s_USB_REG_RD_REQ                        ;
 wire                                s_USB_REG_RD_ACK                        ;
 wire        [  31:0]                s_USB_REG_RD_DATA                       ;
 wire        [  15:0]                s_USB_REG_OP_ADDR                       ;
...
/+=============================================================================*/
 ...
 U_SIM_MODEL (
	 ...
	 .REG0_RD_DATA                   ( 32'h0                         ),//(i)  [ 32]  Register read data
...
/+=============================================================================*/
 ...
 USB_SIM U_USB_SIM (
	 ...
	 .REG_WR_REQ                     ( s_REG0_WR_REQ                         ),
	 .REG_RD_REQ                     ( s_REG0_RD_REQ                         ),
	 .REG_WR_DATA                    ( s_REG0_WR_DATA                        ),
	 .REG_OP_ADDR                    ( {22'h0 ,s_REG0_OP_ADDR}               ),
	 .REG_WR_ACK                     ( s_REG0_WR_ACK                         ),
	 .REG_RD_ACK                     ( s_REG0_RD_ACK                         ),

	 .DRAM_WR_RDY                    ( s_DRAM0_WR_RDY                        ),
	 .DRAM_WR_REQ                    ( s_DRAM0_WR_REQ                        ),
	 .DRAM_WR_ADDR                   ( {7'h0 , s_DRAM0_WR_ADDR}              ),
	 .DRAM_WR_SIZE                   ( {20'h0 ,s_DRAM0_WR_SIZE}              ),
	 .DRAM_WR_ACK                    ( s_DRAM0_WR_ACK                        ),
	 .DRAM_WR_DVLD                   ( s_DRAM0_WR_DVLD                       ),
	 .DRAM_WR_DATA                   ( s_DRAM0_WR_DATA                       ),
	 .DRAM_WR_SOP                    ( s_DRAM0_WR_SOP                        ),
	 .DRAM_WR_EOP                    ( s_DRAM0_WR_EOP                        ),

	 .USB_PCLK                       ( s_USB_PCLK                            ),
	 .USB_DATA                       ( s_USB_DATA                            ),
	 .USB_ADDR                       ( s_USB_ADDR                            ),
	 .USB_FLAGA                      ( s_USB_FLAGA                           ),
	 .USB_FLAGB                      ( s_USB_FLAGB                           ),
	 .USB_PKEND                      ( s_USB_PKEND                           ),
	 .USB_SLOE                       ( s_USB_SLOE                            ),
	 .USB_SLRD                       ( ~s_USB_SLRD                            ),
	 .USB_SLCS                       ( s_USB_SLCS                            ),
	 .USB_SLWR                       ( s_USB_SLWR                            ),
	 .USB_RESET_N                    ( s_USB_RESET_N                         )
 );
...
/+=============================================================================*/
 ...
 USB_TOP U_USB_TOP (
	 ...
	 .DMA_UP_RDY                     ( s_DRAM1_WR_RDY                        ),
	 .DMA_UP_DATA                    ( s_DRAM1_WR_DATA                       ),
	 .DMA_UP_DVLD                    ( s_DRAM1_WR_DVLD                       ),
	 .DMA_UP_SOF                     ( s_DRAM1_WR_SOP                        ),
	 .DMA_UP_EOF                     ( s_DRAM1_WR_EOP                        ),
	 .DMA_UP_REQ                     ( s_DRAM1_WR_REQ                        ),
	 .DMA_UP_VCH                     ( 16'b1                                 ),
	 .DMA_UP_SIZE                    ( {20'h0 , s_DRAM1_WR_SIZE}             ),
	 .DMA_UP_ADDR                    ( { 7'h0 , s_DRAM1_WR_ADDR}             ),

	 .REG0_WR_REQ                    ( s_USB_REG_WR_REQ                      ),
	 .REG0_WR_ACK                    ( s_USB_REG_WR_ACK                      ),
	 .REG0_WR_DATA                   ( s_USB_REG_WR_DATA                     ),
	 .REG0_RD_REQ                    ( s_USB_REG_RD_REQ                      ),
	 .REG0_RD_ACK                    ( s_USB_REG_RD_ACK                      ),
	 .REG0_RD_DATA                   ( s_USB_REG_RD_DATA                     ),
	 .REG0_OP_ADDR                   ( s_USB_REG_OP_ADDR                     ),
...
always @ (posedge s_CLK0_P) begin
 ...
 assign s_DRAM0_RD_ACK               = r_DRAM0_RD_ACK ;
...
/+=============================================================================*/
 ...
 BIST_REG U_BIST_REG(
	 ...
	 .REG_WR_REQ                     ( s_USB_REG_WR_REQ              ),//(i)  [   1]
	 .REG_RD_REQ                     ( s_USB_REG_RD_REQ              ),//(i)  [   1]
	 .REG_WR_ACK                     ( s_USB_REG_WR_ACK              ),//(o)  [   1]
	 .REG_RD_ACK                     ( s_USB_REG_RD_ACK              ),//(o)  [   1]
	 .REG_WR_DATA                    ( s_USB_REG_WR_DATA             ),//(i)  [  32]
	 .REG_RD_DATA                    ( s_USB_REG_RD_DATA             ),//(o)  [  32]
	 .REG_OP_ADDR                    ( s_USB_REG_OP_ADDR             ),//(i)  [  16]
