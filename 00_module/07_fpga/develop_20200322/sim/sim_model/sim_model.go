...
module SIM_MODEL (
    ...
    output      [  15:0]                LBUS_ADDR                               ,//(o)  [ 13]  Local bus address
    ...
    output      [  31:0]                REG0_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG1_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG2_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG3_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG4_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG5_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG6_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  31:0]                REG7_OP_ADDR                            ,//(o)  [ 10]  Register operation address
    ...
    output      [  11:0]                DRAM0_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM0_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM1_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM1_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM2_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM2_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM3_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM3_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM4_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM4_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM5_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM5_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
    ...
    output      [  11:0]                DRAM6_WR_SIZE                           ,//(o)  [ 12]  SDRAM write size
    ...
    output      [  31:0]                DRAM6_WR_DATA                           ,//(o)  [ 32]  SDRAM write data
...
// =============================================================================
    ...
    reg         [   1: 32]              file_dram0_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram1_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram2_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram3_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram4_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram5_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram6_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram7_wr         [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram0_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram1_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram2_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram3_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram4_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram5_exp        [1:8192]          ;//(r) Read file
    reg         [   1: 32]              file_dram6_exp        [1:8192]          ;//(r) Read file
    ...
    reg         [    31:0]              r_REG_OP_ADDR                           ;//(r) Register operation address
           ...
           /*06:Dipswitch*/
            ...
            /*20:REG WR*/
                                cmd_REG_WR : begin
                                    ...
                                    @                   (posedge r_CLK0)            ;
                                    $display            (    "---- Write register   PORT :0x%h    ADD :0x%h    DATA :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0]) ;
                                    $fdisplay           (LOG,"---- Write register   PORT :0x%h    ADD :0x%h    DATA :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0]) ;
                                    REG_WRITE           (r_vb5[31:0], r_vb6[31:0])   ;
                                end
            /*21:REG RD*/
                                cmd_REG_RD : begin
                                    operation           <= "REG read            "   ;
                                    ...
                                    r_REG_CH_SEL[7]     <= (r_vb1[2:0] == 3'h7) ? 1'b1 : 1'b0 ;
                                    @                   (posedge r_CLK0)            ;
                                    REG_READ            (r_vb5[31:0], r_vb6[31:0])   ;
                                    if (r_REG_RD_ERR == 1'b1) begin
                                    $display            (    "---- [Error      ]Read register   PORT :0x%h    ADD :0x%h    EDAT :0x%h    RDAT :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0], r_REG_RD_DATA) ;
                                    $fdisplay           (LOG,"---- [Error      ]Read register   PORT :0x%h    ADD :0x%h    EDAT :0x%h    RDAT :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0], r_REG_RD_DATA) ;
                                    end else begin
                                    $display            (    "---- [Success  ]Read register   PORT :0x%h    ADD :0x%h    EDAT :0x%h    RDAT :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0], r_REG_RD_DATA) ;
                                    $fdisplay           (LOG,"---- [Success  ]Read register   PORT :0x%h    ADD :0x%h    EDAT :0x%h    RDAT :0x%h", r_vb1[2:0], r_vb5[31:0], r_vb6[31:0], r_REG_RD_DATA) ;
                                    end
                                    r_REG_RD_ERR        <= 1'b0                     ;
                                end
            ...
            /*24:DRAM WR*/
                                cmd_DRAM_WR : begin
                                    ...
                                    DRAM_WRITE          (r_vb1[6:0], r_vb2[15:0], r_vb5[24:0], r_vb6[11:0]) ;
...
/+=============================================================================*/
    ...
    task DRAM_WRITE ;
        ...
        begin
            ...
            for (m8=0 ; m8<size[11:2] ; m8=m8+1) begin
                @ ( posedge r_CLK0 ) ; begin
