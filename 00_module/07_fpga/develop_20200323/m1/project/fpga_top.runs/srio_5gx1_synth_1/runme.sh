...
HD_PWD='G:/00_module/07_fpga/develop_20200323/m1/project/fpga_top.runs/srio_5gx1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log srio_5gx1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srio_5gx1.tcl
