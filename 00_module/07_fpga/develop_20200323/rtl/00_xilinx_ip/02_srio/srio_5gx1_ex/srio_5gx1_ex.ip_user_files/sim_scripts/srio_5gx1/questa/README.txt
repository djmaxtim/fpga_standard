...
#
# Generated by export_simulation on Mon Apr 14 13:31:01 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './srio_5gx1.sh' script.

./srio_5gx1.sh -reset_run
...
./srio_5gx1.sh -noclean_files

For more information on the script, please type './srio_5gx1.sh -help'.
