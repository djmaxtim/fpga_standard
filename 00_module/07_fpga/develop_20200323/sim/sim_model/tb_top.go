...
// =============================================================================
 ...
 wire        [  31:0]                s_AXIS_TX_TUSER                         ;

 wire        [  63:0]                s_AXIS_TX_IDATA                         ;
 wire        [   7:0]                s_AXIS_TX_IKEEP                         ;
 wire                                s_AXIS_TX_IVALID                        ;
 wire                                s_AXIS_TX_ILAST                         ;
 wire                                s_AXIS_TX_IREADY                        ;
 wire        [  31:0]                s_AXIS_TX_IUSER                         ;

 reg                                 r_DRAM0_WR_ACK                          ;
 reg                                 r_DRAM0_RD_ACK                          ;

 wire                                s_TAG_REG_WR_REQ                        ;
 wire                                s_TAG_REG_WR_ACK                        ;
 wire        [  31:0]                s_TAG_REG_WR_DATA                       ;
 wire                                s_TAG_REG_RD_REQ                        ;
 wire                                s_TAG_REG_RD_ACK                        ;
 wire        [  31:0]                s_TAG_REG_RD_DATA                       ;
 wire        [  31:0]                s_TAG_REG_OP_ADDR                       ;

 wire                                s_RAM_RD_REQ                            ;
 wire        [  31:0]                s_RAM_RD_ADDR                           ;
 wire        [   8:0]                s_RAM_RD_SIZE                           ;
 wire                                s_RAM_RD_RDY                            ;
 wire                                s_RAM_RD_SOP                            ;
 wire                                s_RAM_RD_EOP                            ;
 wire                                s_RAM_RD_DVLD                           ;
 wire        [  63:0]                s_RAM_RD_DATA                           ;

 wire                                s_RAM_WR_REQ                            ;
 wire        [  31:0]                s_RAM_WR_ADDR                           ;
 wire        [   8:0]                s_RAM_WR_SIZE                           ;
 wire                                s_RAM_WR_SOP                            ;
 wire                                s_RAM_WR_EOP                            ;
 wire                                s_RAM_WR_DVLD                           ;
 wire        [  63:0]                s_RAM_WR_DATA                           ;
...
/+=============================================================================*/
 ...
 SRIO_TOP U_SRIO_TOP (
	 ...
	 .AXIS_RX_IDATA                  ( s_AXIS_TX_TDATA                       ),
	 .AXIS_RX_IKEEP                  ( s_AXIS_TX_TKEEP                       ),
	 .AXIS_RX_ILAST                  ( s_AXIS_TX_TLAST                       ),
	 .AXIS_RX_IVALID                 ( s_AXIS_TX_TVALID                      ),
	 .AXIS_RX_IREADY                 ( s_AXIS_TX_TREADY                      ),
	 .AXIS_RX_IUSER                  ( s_AXIS_TX_TUSER                       ),

	 .AXIS_TX_IDATA                  ( s_AXIS_TX_IDATA                       ),
	 .AXIS_TX_IKEEP                  ( s_AXIS_TX_IKEEP                       ),
	 .AXIS_TX_IVALID                 ( s_AXIS_TX_IVALID                      ),
	 .AXIS_TX_ILAST                  ( s_AXIS_TX_ILAST                       ),
	 .AXIS_TX_IREADY                 ( s_AXIS_TX_IREADY                      ),
	 .AXIS_TX_IUSER                  ( s_AXIS_TX_IUSER                       ),

	 .AXIS_RX_TDATA                  ( s_AXIS_TX_IDATA                       ),
	 .AXIS_RX_TKEEP                  ( s_AXIS_TX_IKEEP                       ),
	 .AXIS_RX_TLAST                  ( s_AXIS_TX_ILAST                       ),
	 .AXIS_RX_TVALID                 ( s_AXIS_TX_IVALID                      ),
	 .AXIS_RX_TREADY                 ( s_AXIS_TX_IREADY                      ),
	 .AXIS_RX_TUSER                  ( s_AXIS_TX_IUSER                       ),
	 ...
	 .INI_WR_RDY                     ( s_DRAM0_WR_RDY                        ),
	 .INI_WR_REQ                     ( s_DRAM0_WR_ACK                        ),
	 .INI_WR_ADDR                    ( {7'h0 , s_DRAM0_WR_ADDR}              ),
	 .INI_WR_SIZE                    ( s_DRAM0_WR_SIZE[8:0]                  ),
	 .INI_WR_DATA                    ( s_DRAM0_WR_DATA                       ),
	 .INI_WR_DVLD                    ( s_DRAM0_WR_DVLD                       ),
	 .INI_WR_SOF                     ( s_DRAM0_WR_SOP                        ),
	 .INI_WR_EOF                     ( s_DRAM0_WR_EOP                        ),

	 .INI_RD_RDY                     ( s_DRAM0_RD_RDY                        ),
	 .INI_RD_REQ                     ( s_DRAM0_RD_ACK                        ),
	 .INI_RD_ADDR                    ( {7'h0 , s_DRAM0_RD_ADDR}              ),
	 .INI_RD_SIZE                    ( s_DRAM0_RD_SIZE[8:0]                  ),
	 .INI_RD_DATA                    (                                       ),
	 .INI_RD_DVLD                    (                                       ),
	 .INI_RD_SOF                     (                                       ),
	 .INI_RD_EOF                     (                                       ),

	 .INI_REG_WR_REQ                 ( s_REG0_WR_REQ                         ),
	 .INI_REG_WR_ACK                 ( s_REG0_WR_ACK                         ),
	 .INI_REG_WR_DATA                ( s_REG0_WR_DATA                        ),
	 .INI_REG_RD_REQ                 ( s_REG0_RD_REQ                         ),
	 .INI_REG_RD_ACK                 ( s_REG0_RD_ACK                         ),
	 .INI_REG_RD_DATA                ( s_REG0_RD_DATA                        ),
	 .INI_REG_OP_ADDR                ( {22'h0 ,s_REG0_OP_ADDR}               ),

	 .TAG_WR_RDY                     ( 1'b1                                  ),
	 .TAG_WR_REQ                     ( s_RAM_WR_REQ                          ),
	 .TAG_WR_ADDR                    ( s_RAM_WR_ADDR                         ),
	 .TAG_WR_SIZE                    ( s_RAM_WR_SIZE                         ),
	 .TAG_WR_DATA                    ( s_RAM_WR_DATA                         ),
	 .TAG_WR_DVLD                    ( s_RAM_WR_DVLD                         ),
	 .TAG_WR_SOF                     ( s_RAM_WR_SOF                          ),
	 .TAG_WR_EOF                     ( s_RAM_WR_EOF                          ),

	 .TAG_RD_RDY                     ( s_RAM_RD_RDY                          ),
	 .TAG_RD_REQ                     ( s_RAM_RD_REQ                          ),
	 .TAG_RD_SIZE                    ( s_RAM_RD_SIZE                         ),
	 .TAG_RD_ADDR                    ( s_RAM_RD_ADDR                         ),
	 .TAG_RD_DATA                    ( s_RAM_RD_DATA                         ),
	 .TAG_RD_DVLD                    ( s_RAM_RD_DVLD                         ),
	 .TAG_RD_SOF                     ( s_RAM_RD_SOP                          ),
	 .TAG_RD_EOF                     ( s_RAM_RD_EOP                          ),

	 .TAG_REG_WR_REQ                 ( s_TAG_REG_WR_REQ                      ),
	 .TAG_REG_WR_ACK                 ( s_TAG_REG_WR_ACK                      ),
	 .TAG_REG_WR_DATA                ( s_TAG_REG_WR_DATA                     ),
	 .TAG_REG_RD_REQ                 ( s_TAG_REG_RD_REQ                      ),
	 .TAG_REG_RD_ACK                 ( s_TAG_REG_RD_ACK                      ),
	 .TAG_REG_RD_DATA                ( s_TAG_REG_RD_DATA                     ),
	 .TAG_REG_OP_ADDR                ( s_TAG_REG_OP_ADDR                     )
 );

always @ (posedge s_CLK0_P) begin
	 if (~s_XRST0) begin
		 r_DRAM0_WR_ACK              <= 'b0 ;
		 r_DRAM0_RD_ACK              <= 'b0 ;
	 end else begin
		 r_DRAM0_WR_ACK              <= s_DRAM0_WR_REQ ;
		 r_DRAM0_RD_ACK              <= s_DRAM0_RD_REQ ;
	 end
 end

 assign s_DRAM0_WR_ACK               = s_DRAM0_WR_REQ & ~r_DRAM0_WR_ACK ;
 assign s_DRAM0_RD_ACK               = s_DRAM0_RD_REQ & ~r_DRAM0_RD_ACK ;
...
/+=============================================================================*/
 ...
 BIST_REG U_BIST_REG(
	 ...
	 .REG_WR_REQ                     ( s_TAG_REG_WR_REQ                      ),//(i)  [   1]
	 .REG_RD_REQ                     ( s_TAG_REG_RD_REQ                      ),//(i)  [   1]
	 .REG_WR_ACK                     ( s_TAG_REG_WR_ACK                      ),//(o)  [   1]
	 .REG_RD_ACK                     ( s_TAG_REG_RD_ACK                      ),//(o)  [   1]
	 .REG_WR_DATA                    ( s_TAG_REG_WR_DATA                     ),//(i)  [  32]
	 .REG_RD_DATA                    ( s_TAG_REG_RD_DATA                     ),//(o)  [  32]
	 .REG_OP_ADDR                    ( s_TAG_REG_OP_ADDR[15:0]               ),//(i)  [  16]
 ...
 RAM_BIST U_RAM_BIST(
	 ...
	 .RAM_RD_REQ                     ( s_RAM_RD_REQ                          ),//(i)  [   1]
	 .RAM_RD_ADDR                    ( s_RAM_RD_ADDR[15:0]                   ),//(i)  [   1]
	 .RAM_RD_SIZE                    ( {7'h0 , s_RAM_RD_SIZE}                ),//(o)  [   1]
	 .RAM_RD_BSEL                    ( 16'h1                                 ),//(o)  [   1]
	 .RAM_RD_RDY                     ( s_RAM_RD_RDY                          ),//(i)  [  32]
	 .RAM_RD_SOP                     ( s_RAM_RD_SOP                          ),//(i)  [  32]
	 .RAM_RD_EOP                     ( s_RAM_RD_EOP                          ),//(i)  [  32]
	 .RAM_RD_DVLD                    ( s_RAM_RD_DVLD                         ),//(i)  [  32]
	 .RAM_RD_DATA                    ( s_RAM_RD_DATA                         ),//(o)  [  32]

	 .RAM_WR_REQ                     ( s_RAM_WR_REQ                          ),//(i)  [  32]
	 .RAM_WR_ADDR                    ( s_RAM_WR_ADDR[15:0]                   ),//(i)  [  32]
	 .RAM_WR_SIZE                    ( {7'h0 , s_RAM_WR_SIZE}                ),//(i)  [  32]
	 .RAM_WR_BSEL                    ( 16'h1                                 ),//(i)  [  32]
	 .RAM_WR_DATA                    ( s_RAM_WR_DATA                         ),//(i)  [  32]
	 .RAM_WR_DVLD                    ( s_RAM_WR_DVLD                         ),//(i)  [  32]
	 .RAM_WR_SOP                     ( s_RAM_WR_SOP                          ),//(i)  [  32]
	 .RAM_WR_EOP                     ( s_RAM_WR_EOP                          ) //(i)  [  32]
 );
