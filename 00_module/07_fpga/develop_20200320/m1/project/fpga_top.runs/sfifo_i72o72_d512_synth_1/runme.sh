...
HD_PWD='G:/00_module/07_fpga/sim_demo20200320/m1/project/fpga_top.runs/sfifo_i72o72_d512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sfifo_i72o72_d512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sfifo_i72o72_d512.tcl
