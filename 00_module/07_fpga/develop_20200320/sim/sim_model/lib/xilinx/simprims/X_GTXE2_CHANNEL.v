...
module X_GTXE2_CHANNEL (
  ...
  initial begin
    ...
    case (RXOUT_DIV)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute RXOUT_DIV on X_GTXE2_CHANNEL instance %m is set to %d.  Legal values for this attribute are 1 to 16.", RXOUT_DIV, 2);
        $finish;
      end
    endcase 
    ...
    case (SIM_VERSION)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute SIM_VERSION on X_GTXE2_CHANNEL instance %m is set to %s.  Legal values for this attribute are 1.1, 1.0, or 2.0.", SIM_VERSION);
        $finish;
      end
    endcase
    ...
    case (TXOUT_DIV)
      ...
      default : begin
        $display("Attribute Syntax Error : The Attribute TXOUT_DIV on X_GTXE2_CHANNEL instance %m is set to %d.  Legal values for this attribute are 1 to 16.", TXOUT_DIV, 2);
        $finish;
      end
    endcase 
  ...
  specify
    ...
    ( QPLLCLK *> GTREFCLKMONITOR) = (0:0:0, 0:0:0);
    ...
    ( RXUSRCLK2 *> RXCHARISCOMMA) = (0:0:0, 0:0:0);
    ( RXUSRCLK2 *> RXCHARISK) = (0:0:0, 0:0:0);
    ...
    ( RXUSRCLK2 *> RXDISPERR) = (0:0:0, 0:0:0);
    ( RXUSRCLK2 *> RXHEADER) = (0:0:0, 0:0:0);
    ( RXUSRCLK2 *> RXHEADERVALID) = (0:0:0, 0:0:0);
    ( RXUSRCLK2 *> RXNOTINTABLE) = (0:0:0, 0:0:0);
