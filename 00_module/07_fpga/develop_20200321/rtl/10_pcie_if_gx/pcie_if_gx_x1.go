...
module PCIE_IF_GX (
    input                               PCIE_NPERST                             ,//(i)  [  1]
    input                               PCIE_REFCLK_P                           ,//(i)  [  1]
    input                               PCIE_REFCLK_N                           ,//(i)  [  1]
    input                               PCIE_RX_P                               ,//(i)  [  1]
    input                               PCIE_RX_N                               ,//(i)  [  1]
    output                              PCIE_TX_P                               ,//(o)  [  1]
    output                              PCIE_TX_N                               ,//(o)  [  1]


    output                              PCIE_CLK_OUT                            ,//(o)  [  1]
    output                              PCIE_RST_OUT                            ,//(o)  [  1]
    output                              PCIE_LINK_UP                            ,//(o)  [  1]
...
// =============================================================================
    ...
    wire                                s_PCIE_REFCLK                           ;//(s)  [  1]
    wire                                s_PIPE_PCLK_IN                          ;//(s)  [  1]
    wire                                s_PIPE_RXUSRCLK_IN                      ;//(s)  [  1]
    wire                                s_PIPE_RXOUTCLK_IN                      ;//(s)  [  4]
    wire                                s_PIPE_DCLK_IN                          ;//(s)  [  1]
    wire                                s_PIPE_OOBCLK_IN                        ;//(s)  [  1]
    wire                                s_PIPE_USERCLK1_IN                      ;//(s)  [  1]
    wire                                s_PIPE_USERCLK2_IN                      ;//(s)  [  1]
    wire                                s_PIPE_MMCM_LOCK_IN                     ;//(s)  [  1]

    wire                                s_PIPE_TXOUTCLK_OUT                     ;//(s)  [  1]
    wire                                s_PIPE_RXOUTCLK_OUT                     ;//(s)  [  1]
    wire                                s_PIPE_PCLK_SEL_OUT                     ;//(s)  [  1]
    wire                                s_PIPE_GEN3_OUT                         ;//(s)  [  1]

    wire                                s_USER_CLK_OUT                          ;//(s)  [  1]
    wire                                s_USER_RESET_OUT                        ;//(s)  [  1]
    wire                                s_USER_LNK_UP                           ;//(s)  [  1]
    wire        [   5:0]                s_TX_BUF_AV                             ;//(s)  [  6]
    wire                                s_CFG_TO_TURNOFF                        ;//(s)  [  1]
    reg                                 r_CFG_TURNOFF_OK                        ;//(r)  [  1]
    wire        [  15:0]                s_CFG_COMMAND                           ;//(s)  [ 16]
    wire        [  15:0]                s_CFG_DCOMMAND                          ;//(s)  [ 16]
    wire                                s_CFG_INTERRUPT                         ;//(s)  [  1]
    wire                                s_CFG_INTERRUPT_RDY                     ;//(s)  [  1]
    wire                                s_CFG_INTERRUPT_ASSERT                  ;//(s)  [  1]
    wire        [   7:0]                s_CFG_INTERRUPT_DI                      ;//(s)  [  8]
    wire        [   7:0]                s_CFG_INTERRUPT_DO                      ;//(s)  [  8]
    wire        [   2:0]                s_CFG_INTERRUPT_MMENABLE                ;//(s)  [  3]
    wire                                s_CFG_INTERRUPT_MSIENABLE               ;//(s)  [  1]
    wire        [   7:0]                s_CFG_BUS_NUMBER                        ;//(s)  [  8]
    wire        [   4:0]                s_CFG_DEVICE_NUMBER                     ;//(s)  [  5]
    wire        [   2:0]                s_CFG_FUNCTION_NUMBER                   ;//(s)  [  3]

    wire                                s_BUS_MSTR_EN                           ;//(s)  [  1]
    wire        [   2:0]                s_MAX_RD_REQ_SIZE                       ;//(s)  [  3]
    wire        [   2:0]                s_MAX_PL_SIZE                           ;//(s)  [  3]
    wire                                s_EXT_TAG_EN                            ;//(s)  [  1]
...
/+=============================================================================*/
    ...
    PCIE_TX U_PCIE_TX (
        ...
        //pcie core
        .AXIS_TX_TDATA                              ( s_AXIS_TX_TDATA           ),//(i)  [  1]
        .AXIS_TX_TKEEP                              ( s_AXIS_TX_TKEEP           ),//(o)  [  1]
        .AXIS_TX_TVALID                             ( s_AXIS_TX_TVALID          ),//(o)  [  1]
        .AXIS_TX_TLAST                              ( s_AXIS_TX_TLAST           ),//(o)  [ 64]
        .AXIS_TX_TREADY                             ( s_AXIS_TX_TREADY          ),//(o)  [  2]
        .AXIS_TX_TUSER                              ( s_AXIS_TX_TUSER           ) //(o)  [  1]
        );
...
/+=============================================================================*/
    ...
    PCIE_DN_REG U_PCIE_DN_REG (
        ...
        .DN0_FILE_SOF                               ( s_DN_FILE_SOF        [0]  ),//(i)  [  1]
        .DN0_FILE_EOF                               ( s_DN_FILE_EOF        [0]  ),//(i)  [  1]
        .DN0_FILE_VCH                               ( s_DN_FILE_VCH        [0]  ),//(i)  [  8]
        .DN0_FILE_ADDR                              ( s_DN_FILE_ADDR       [0]  ),//(i)  [ 32]
        .DN0_FILE_SIZE                              ( s_DN_FILE_SIZE       [0]  ),//(i)  [ 32]

        .DN1_FILE_SOF                               ( s_DN_FILE_SOF        [1]  ),//(i)  [  1]
        .DN1_FILE_EOF                               ( s_DN_FILE_EOF        [1]  ),//(i)  [  1]
        .DN1_FILE_VCH                               ( s_DN_FILE_VCH        [1]  ),//(i)  [  8]
        .DN1_FILE_ADDR                              ( s_DN_FILE_ADDR       [1]  ),//(i)  [ 32]
        .DN1_FILE_SIZE                              ( s_DN_FILE_SIZE       [1]  ),//(i)  [ 32]
        ...
        //empty buffer
        .DN0_FBUF_RD_REQ                            ( s_DN_FBUF_RD_REQ     [0]  ),//(o)  [  1]
        ...
        .DN1_FBUF_RD_REQ                            ( s_DN_FBUF_RD_REQ     [1]  ),//(o)  [  1]
    ...
    PCIE_UP_REG U_PCIE_UP_REG (
        ...
        //empty buffer
        .UP0_EBUF_RD_REQ                            ( s_UP_EBUF_RD_REQ     [0]  ),//(o)  [  1]
        ...
        .UP1_EBUF_RD_REQ                            ( s_UP_EBUF_RD_REQ     [1]  ),//(o)  [  1]
...
/+============================================================================*/
    ...
    for (i=0 ; i<=p_CH_NM-1 ; i=i+1) begin : GROUP_DN
        ...
        U_PCIE_DN_DMA (
            ...
            .DN_FBUF_RD_TRIG                        ( s_DN_FBUF_RD_TRIG     [i] ),//(o)  [  1]
            .DN_FBUF_RD_ADDR                        ( s_DN_FBUF_RD_ADDR     [i] ),//(i)  [ 96]
            .DN_FBUF_RD_SIZE                        ( s_DN_FBUF_RD_SIZE     [i] ),//(i)  [ 96]
...
/+============================================================================*/
    ...
    for (j=0 ; j<=p_CH_NM-1 ; j=j+1) begin : GROUP_UP
        ...
        U_PCIE_UP_DMA (
            ...
            .UP_EBUF_RD_TRIG                        ( s_UP_EBUF_RD_TRIG    [j]  ),//(o)  [  1]
            .UP_EBUF_RD_ADDR                        ( s_UP_EBUF_RD_ADDR    [j]  ),//(o)  [ 64]
            .UP_EBUF_RD_SIZE                        ( s_UP_EBUF_RD_SIZE    [j]  ),//(o)  [ 24]
...
/+============================================================================*/
    ...
    pcie_7x_v1_6_pipe_clock # (
        .PCIE_ASYNC_EN                              ( "FALSE"                   ),//(p) PCIe async enable
        .PCIE_TXBUF_EN                              ( "FALSE"                   ),//(p) PCIe TX buffer enable for Gen1/Gen2 only
        .PCIE_LANE                                  ( 6'h01                     ),//(p) PCIe number of lanes
        .PCIE_LINK_SPEED                            ( 3                         ),//(p)
        .PCIE_REFCLK_FREQ                           ( 1                         ),//(p) PCIe reference clock frequency // 0=100mhz 1=125mhz
        .PCIE_USERCLK1_FREQ                         ( 2                         ),//(p) PCIe user clock 1 frequency
        .PCIE_USERCLK2_FREQ                         ( 2                         ),//(p) PCIe user clock 2 frequency
        .PCIE_DEBUG_MODE                            ( 0                         )
        )
    U_PIPE_CLOCK (
        //Input
        .CLK_CLK                                    ( s_PCIE_REFCLK             ),//(i)
        .CLK_TXOUTCLK                               ( s_PIPE_TXOUTCLK_OUT       ),//(i) Reference clock from lane 0
        .CLK_RXOUTCLK_IN                            ( s_PIPE_RXOUTCLK_OUT       ),//(i)
        .CLK_RST_N                                  ( 1'b1                      ),//(i)
        .CLK_PCLK_SEL                               ( s_PIPE_PCLK_SEL_OUT       ),//(i)
        .CLK_GEN3                                   ( s_PIPE_GEN3_OUT           ),//(i)

        //Output
        .CLK_PCLK                                   ( s_PIPE_PCLK_IN            ),//(o)
        .CLK_RXUSRCLK                               ( s_PIPE_RXUSRCLK_IN        ),//(o)
        .CLK_RXOUTCLK_OUT                           ( s_PIPE_RXOUTCLK_IN        ),//(o)
        .CLK_DCLK                                   ( s_PIPE_DCLK_IN            ),//(o)
        .CLK_OOBCLK                                 ( s_PIPE_OOBCLK_IN          ),//(o)
        .CLK_USERCLK1                               ( s_PIPE_USERCLK1_IN        ),//(o)
        .CLK_USERCLK2                               ( s_PIPE_USERCLK2_IN        ),//(o)
        .CLK_MMCM_LOCK                              ( s_PIPE_MMCM_LOCK_IN       ) //(o)
        );
...
/+============================================================================*/
    ...
    U_PCI_EXP_EP(
        ...
        .pci_exp_txn                                ( PCIE_TX_N                 ),//(o)
        .pci_exp_txp                                ( PCIE_TX_P                 ),//(o)
        .pci_exp_rxn                                ( PCIE_RX_N                 ),//(i)
        .pci_exp_rxp                                ( PCIE_RX_P                 ),//(i)
        .sys_reset                                  ( ~PCIE_NPERST              ),//(i)
        .sys_clk                                    ( s_PCIE_REFCLK             ),//(i)
        // 2. Clock Inputs
        .PIPE_PCLK_IN                               ( s_PIPE_PCLK_IN            ),//(i)
        .PIPE_RXUSRCLK_IN                           ( s_PIPE_RXUSRCLK_IN        ),//(i)
        .PIPE_RXOUTCLK_IN                           ( s_PIPE_RXOUTCLK_IN        ),//(i)
        .PIPE_DCLK_IN                               ( s_PIPE_DCLK_IN            ),//(i)
        .PIPE_USERCLK1_IN                           ( s_PIPE_USERCLK1_IN        ),//(i)
        .PIPE_OOBCLK_IN                             ( s_PIPE_OOBCLK_IN          ),//(i)
        .PIPE_USERCLK2_IN                           ( s_PIPE_USERCLK2_IN        ),//(i)
        .PIPE_MMCM_LOCK_IN                          ( s_PIPE_MMCM_LOCK_IN       ),//(i)
        .PIPE_TXOUTCLK_OUT                          ( s_PIPE_TXOUTCLK_OUT       ),//(o)
        .PIPE_RXOUTCLK_OUT                          ( s_PIPE_RXOUTCLK_OUT       ),//(o)
        .PIPE_PCLK_SEL_OUT                          ( s_PIPE_PCLK_SEL_OUT       ),//(o)
        .PIPE_GEN3_OUT                              ( s_PIPE_GEN3_OUT           ),//(o)
        // 3. AXI-S Interface
        // Common
        .user_clk_out                               ( s_USER_CLK_OUT            ),//(o)
        .user_reset_out                             ( s_USER_RESET_OUT          ),//(o)
        .user_lnk_up                                ( s_USER_LNK_UP             ),//(o)
        // Tx
        .tx_buf_av                                  ( s_TX_BUF_AV               ),//(o) [ 5:0]
        .tx_err_drop                                (                           ),//(o)
        .tx_cfg_req                                 (                           ),//(o)
        .s_axis_tx_tready                           ( s_AXIS_TX_TREADY          ),//(o)
        .s_axis_tx_tdata                            ( s_AXIS_TX_TDATA           ),//(i) [63:0]
        .s_axis_tx_tkeep                            ( s_AXIS_TX_TKEEP           ),//(i) [ 7:0]
        .s_axis_tx_tuser                            ( s_AXIS_TX_TUSER           ),//(i) [ 3:0]
        .s_axis_tx_tlast                            ( s_AXIS_TX_TLAST           ),//(i)
        .s_axis_tx_tvalid                           ( s_AXIS_TX_TVALID          ),//(i)
        .tx_cfg_gnt                                 ( 1'b1                      ),//(i)
        // Rx
        .m_axis_rx_tdata                            ( s_AXIS_RX_TDATA           ),//(o) [63:0]
        .m_axis_rx_tkeep                            ( s_AXIS_RX_TKEEP           ),//(o) [ 7:0]
        .m_axis_rx_tlast                            ( s_AXIS_RX_TLAST           ),//(o)
        .m_axis_rx_tvalid                           ( s_AXIS_RX_TVALID          ),//(o)
        .m_axis_rx_tready                           ( s_AXIS_RX_TREADY          ),//(i)
        .m_axis_rx_tuser                            ( s_AXIS_RX_TUSER           ),//(o) [21:0]
        .rx_np_ok                                   ( 1'b1                      ),//(i)
        .rx_np_req                                  ( 1'b1                      ),//(i)
        // Flow Control
        .fc_cpld                                    (                           ),//(o)
        ...
        .cfg_status                                 (                           ),//(o) [15:0]
        .cfg_command                                ( s_CFG_COMMAND             ),//(o) [15:0]
        .cfg_dstatus                                (                           ),//(o) [15:0]
        .cfg_dcommand                               ( s_CFG_DCOMMAND            ),//(o) [15:0]
        .cfg_lstatus                                (                           ),//(o) [15:0]
        .cfg_lcommand                               (                           ),//(o) [15:0]
        .cfg_dcommand2                              (                           ),//(o) [15:0]
        .cfg_pcie_link_state                        (                           ),//(o) [ 2:0]
        .cfg_pmcsr_pme_en                           (                           ),//(o)
        .cfg_pmcsr_powerstate                       (                           ),//(o) [ 1:0]
        .cfg_pmcsr_pme_status                       (                           ),//(o)
        .cfg_received_func_lvl_rst                  (                           ),//(o)
        // Management Interface
        .cfg_mgmt_di                                ( 32'h0                     ),//(i) [31:0]
        .cfg_mgmt_byte_en                           ( 4'h0                      ),//(i) [ 3:0]
        .cfg_mgmt_dwaddr                            ( 10'h0                     ),//(i) [ 9:0]
        .cfg_mgmt_wr_en                             ( 1'b0                      ),//(i)
        .cfg_mgmt_rd_en                             ( 1'b0                      ),//(i)
        .cfg_mgmt_wr_readonly                       ( 1'b0                      ),//(i)
        // Error Reporting Interface
        .cfg_err_ecrc                               ( 1'b0                      ),//(i)
        .cfg_err_ur                                 ( 1'b0                      ),//(i)
        .cfg_err_cpl_timeout                        ( 1'b0                      ),//(i)
        .cfg_err_cpl_unexpect                       ( 1'b0                      ),//(i)
        .cfg_err_cpl_abort                          ( 1'b0                      ),//(i)
        .cfg_err_posted                             ( 1'b0                      ),//(i)
        .cfg_err_cor                                ( 1'b0                      ),//(i)
        ...
        .cfg_err_cpl_rdy                            (                           ),//(o)
        .cfg_err_locked                             ( 1'b0                      ),//(i)
        .cfg_err_acs                                ( 1'b0                      ),//(i)
        .cfg_err_internal_uncor                     ( 1'b0                      ),//(i)
        .cfg_trn_pending                            ( 1'b0                      ),//(i)
        .cfg_pm_halt_aspm_l0s                       ( 1'b0                      ),//(i)
        .cfg_pm_halt_aspm_l1                        ( 1'b0                      ),//(i)
        .cfg_pm_force_state_en                      ( 1'b0                      ),//(i)
        .cfg_pm_force_state                         ( 2'b00                     ),//(i) [ 1:0]
        .cfg_dsn                                    ( 64'h0000_0001_0100_0A35   ),//(i) [63:0]
        // EP Only
        .cfg_interrupt                              (~s_CFG_INTERRUPT           ),//(i)
        .cfg_interrupt_rdy                          ( s_CFG_INTERRUPT_RDY       ),//(o)
        .cfg_interrupt_assert                       (~s_CFG_INTERRUPT_ASSERT    ),//(i)
        .cfg_interrupt_di                           ( s_CFG_INTERRUPT_DI        ),//(i) [ 7:0]
        .cfg_interrupt_do                           ( s_CFG_INTERRUPT_DO        ),//(o) [ 7:0]
        .cfg_interrupt_mmenable                     ( s_CFG_INTERRUPT_MMENABLE  ),//(o) [ 2:0]
        .cfg_interrupt_msienable                    ( s_CFG_INTERRUPT_MSIENABLE ),//(o)
        .cfg_interrupt_msixenable                   (                           ),//(o)
        .cfg_interrupt_msixfm                       (                           ),//(o)
        .cfg_interrupt_stat                         ( 1'b0                      ),//(i)
        .cfg_pciecap_interrupt_msgnum               ( 5'b00000                  ),//(i) [ 4:0]
        .cfg_to_turnoff                             ( s_CFG_TO_TURNOFF          ),//(o)
        .cfg_turnoff_ok                             ( r_CFG_TURNOFF_OK          ),//(i)
        .cfg_bus_number                             ( s_CFG_BUS_NUMBER          ),//(o) [ 7:0]
        .cfg_device_number                          ( s_CFG_DEVICE_NUMBER       ),//(o) [ 4:0]
        .cfg_function_number                        ( s_CFG_FUNCTION_NUMBER     ),//(o) [ 2:0]
        .cfg_pm_wake                                ( 1'b0                      ),//(i)
        // RP Only
        .cfg_pm_send_pme_to                         ( 1'b0                      ),//(i)
        .cfg_ds_bus_number                          ( 8'b0                      ),//(i) [ 7:0]
        .cfg_ds_device_number                       ( 5'b0                      ),//(i) [ 4:0]
        .cfg_ds_function_number                     ( 3'b0                      ),//(i) [ 2:0]
        .cfg_mgmt_wr_rw1c_as_rw                     ( 1'b0                      ),//(i)
        .cfg_msg_received                           (                           ),//(o)
        .cfg_msg_data                               (                           ),//(o) [15:0]
        .cfg_bridge_serr_en                         (                           ),//(o)
        .cfg_slot_control_electromech_il_ctl_pulse  (                           ),//(o)
        .cfg_root_control_syserr_corr_err_en        (                           ),//(o)
        .cfg_root_control_syserr_non_fatal_err_en   (                           ),//(o)
        .cfg_root_control_syserr_fatal_err_en       (                           ),//(o)
        .cfg_root_control_pme_int_en                (                           ),//(o)
        .cfg_aer_rooterr_corr_err_reporting_en      (                           ),//(o)
        .cfg_aer_rooterr_non_fatal_err_reporting_en (                           ),//(o)
        .cfg_aer_rooterr_fatal_err_reporting_en     (                           ),//(o)
        .cfg_aer_rooterr_corr_err_received          (                           ),//(o)
        .cfg_aer_rooterr_non_fatal_err_received     (                           ),//(o)
        .cfg_aer_rooterr_fatal_err_received         (                           ),//(o)
        .cfg_msg_received_err_cor                   (                           ),//(o)
        .cfg_msg_received_err_non_fatal             (                           ),//(o)
        .cfg_msg_received_err_fatal                 (                           ),//(o)
        .cfg_msg_received_pm_as_nak                 (                           ),//(o)
        .cfg_msg_received_pme_to_ack                (                           ),//(o)
        .cfg_msg_received_assert_int_a              (                           ),//(o)
        .cfg_msg_received_assert_int_b              (                           ),//(o)
        .cfg_msg_received_assert_int_c              (                           ),//(o)
        .cfg_msg_received_assert_int_d              (                           ),//(o)
        .cfg_msg_received_deassert_int_a            (                           ),//(o)
        .cfg_msg_received_deassert_int_b            (                           ),//(o)
        .cfg_msg_received_deassert_int_c            (                           ),//(o)
        .cfg_msg_received_deassert_int_d            (                           ),//(o)
        // 5. Physical Layer Control and Status
        .pl_directed_link_change                    ( 2'b00                     ),//(i) [ 1:0]
        .pl_directed_link_width                     ( 2'b00                     ),//(i) [ 1:0]
        .pl_directed_link_speed                     ( 1'b0                      ),//(i)
        .pl_directed_link_auton                     ( 1'b0                      ),//(i)
        .pl_upstream_prefer_deemph                  ( 1'b1                      ),//(i)
        .pl_sel_lnk_rate                            (                           ),//(o)
        .pl_sel_lnk_width                           (                           ),//(o) [ 1:0]
        .pl_ltssm_state                             (                           ),//(o) [ 5:0]
        .pl_lane_reversal_mode                      (                           ),//(o) [ 1:0]
        .pl_phy_lnk_up                              (                           ),//(o)
        .pl_tx_pm_state                             (                           ),//(o) [ 2:0]
        .pl_rx_pm_state                             (                           ),//(o) [ 1:0]
        .pl_link_upcfg_cap                          (                           ),//(o)
        .pl_link_gen2_cap                           (                           ),//(o)
        .pl_link_partner_gen2_supported             (                           ),//(o)
        .pl_initial_link_width                      (                           ),//(o) [ 2:0]
        .pl_directed_change_done                    (                           ),//(o)
        // EP Only
        .pl_received_hot_rst                        (                           ),//(o)
        // RP Only
        .pl_transmit_hot_rst                        ( 1'b0                      ),//(i)
        .pl_downstream_deemph_source                ( 1'b0                      ),//(i)
        // 6. AER interface
        .cfg_err_aer_headerlog                      ( 128'h0                    ),//(i) [127:0]
        .cfg_aer_interrupt_msgnum                   ( 5'b00000                  ),//(i) [ 4:0]
        .cfg_err_aer_headerlog_set                  (                           ),//(o)
        .cfg_aer_ecrc_check_en                      (                           ),//(o)
        .cfg_aer_ecrc_gen_en                        (                           ),//(o)
        // 7. VC interface
        .cfg_vc_tcvc_map                            (                           ) //(o) [ 6:0]
        );
...
/+============================================================================*/
    ...
    always @ (posedge s_USER_CLK_OUT or posedge s_USER_RESET_OUT) begin
        if (s_USER_RESET_OUT) begin
            r_CFG_TURNOFF_OK            <= 1'b0 ;
        end else begin
            r_CFG_TURNOFF_OK            <= s_CFG_TO_TURNOFF ;
        end
    end

    assign PCIE_CLK_OUT                 =  s_USER_CLK_OUT           ;
    assign PCIE_RST_OUT                 =  s_USER_RESET_OUT         ;
    assign PCIE_LINK_UP                 =  s_USER_LNK_UP            ;

    assign s_EXT_TAG_EN                 =  s_CFG_DCOMMAND[8]        ;
    assign s_BUS_MSTR_EN                =  s_CFG_COMMAND[2]         ;
    assign s_MAX_RD_REQ_SIZE            =  s_CFG_DCOMMAND[14:12]    ;
    assign s_MAX_PL_SIZE                =  s_CFG_DCOMMAND[7:5]      ;
