...
//  assign  s_UEK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) & ( UEK_TX_REQ)                                                                                 ;
    assign  s_UFK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) &  ( UFK_TX_REQ)                                                                 ;
    assign  s_DEK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) &  (~UFK_TX_REQ) & ( DEK_TX_REQ)                                                 ;
//  assign  s_DFK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) & (~UEK_TX_REQ) & (~UFK_TX_REQ) & (~DEK_TX_REQ) & ( DFK_TX_REQ)                                 ;
    assign  s_DPK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) &  (~UFK_TX_REQ) & (~DEK_TX_REQ) & ( DPK_TX_REQ)                 ;
    assign  s_UPK_TX_ACK                = s_FSM_IDLE & (~r_BUF_AFULL) & (~CPK_TX_REQ) &  (~UFK_TX_REQ) & (~DEK_TX_REQ) & (~DPK_TX_REQ) & ( UPK_TX_REQ) ;
