...
module PCIE_UP_DMA # (
    ...
    input                               UP_EBUF_RD_TRIG                         ,//(o)  [  1]
    input       [  63:0]                UP_EBUF_RD_ADDR                         ,//(i)  [ 96]
    input       [  23:0]                UP_EBUF_RD_SIZE                         ,//(i)  [ 96]
...
// =============================================================================
    ...
    localparam                          p_IDLE          = 5'b00001              ;//(p)  [  6]
    localparam                          p_EBUF_REQ      = 5'b00010              ;//(p)  [  6]
    localparam                          p_TX_REQ        = 5'b00100              ;//(p)  [  6]
    localparam                          p_TX_DATA       = 5'b01000              ;//(p)  [  6]
    localparam                          p_FBUF_REQ      = 5'b10000              ;//(p)  [  6]
