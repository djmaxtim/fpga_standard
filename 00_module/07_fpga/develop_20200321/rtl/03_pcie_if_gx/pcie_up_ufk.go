...
//          r_DMA_ADDR                  <= r_UP_FBUF_WR_ADDR + r_OFT_ADDR[21:0] ;//select whether to offset the address according to the requirements.
            r_DMA_ADDR                  <= r_UP_FBUF_WR_ADDR ;
        end
    end
...
//          r_DMA_DATA                      <= {r_UP_FBUF_WR_DATA[127:122] , ~r_OFT_ADDR[22] , r_OFT_ADDR[22] , r_UP_FBUF_WR_DATA[119:0]} ;
            r_DMA_DATA                      <= {r_UP_FBUF_WR_DATA[127:122] , 2'b0 , r_UP_FBUF_WR_DATA[119:0]} ;
        end
    end
