...
module PCIE_DN_REG (
    ...
    //file info
    output                              DN0_FILE_SOF                            ,//(o)  [  1]
    output                              DN0_FILE_EOF                            ,//(o)  [  1]
    output      [  15:0]                DN0_FILE_VCH                            ,//(o)  [ 16]
    output      [  31:0]                DN0_FILE_ADDR                           ,//(o)  [ 32]
    output      [  31:0]                DN0_FILE_SIZE                           ,//(o)  [ 32]

    output                              DN1_FILE_SOF                            ,//(o)  [  1]
    output                              DN1_FILE_EOF                            ,//(o)  [  1]
    output      [  15:0]                DN1_FILE_VCH                            ,//(o)  [ 16]
    output      [  31:0]                DN1_FILE_ADDR                           ,//(o)  [ 32]
    output      [  31:0]                DN1_FILE_SIZE                           ,//(o)  [ 32]
...
// =============================================================================
    ...
    localparam  p_ADD_DN0_FILE0         = 16'h0200                              ;//(p)  [ 16]
    localparam  p_ADD_DN0_FILE1         = 16'h0208                              ;//(p)  [ 16]
    localparam  p_ADD_DN0_FILE2         = 16'h0210                              ;//(p)  [ 16]
    ...
    localparam  p_ADD_DN1_FILE0         = 16'h1200                              ;//(p)  [ 16]
    localparam  p_ADD_DN1_FILE1         = 16'h1208                              ;//(p)  [ 16]
    localparam  p_ADD_DN1_FILE2         = 16'h1210                              ;//(p)  [ 16]
...
// =============================================================================
    ...
    reg                                 r_DN0_FILE_SOF                          ;//(r)  [ 24]
    reg                                 r_DN0_FILE_EOF                          ;//(r)  [ 24]
    reg         [  15:0]                r_DN0_FILE_VCH                          ;//(r)  [ 24]
    reg         [  31:0]                r_DN0_FILE_ADDR                         ;//(r)  [ 24]
    reg         [  31:0]                r_DN0_FILE_SIZE                         ;//(r)  [ 24]

    reg                                 r_DN1_FILE_SOF                          ;//(r)  [ 24]
    reg                                 r_DN1_FILE_EOF                          ;//(r)  [ 24]
    reg         [  15:0]                r_DN1_FILE_VCH                          ;//(r)  [ 24]
    reg         [  31:0]                r_DN1_FILE_ADDR                         ;//(r)  [ 24]
    reg         [  31:0]                r_DN1_FILE_SIZE                         ;//(r)  [ 24]
    ...
    wire                                s_REG_DN0_FILE0_EN                      ;//(s)  [  1]
    wire                                s_REG_DN0_FILE1_EN                      ;//(s)  [  1]
    wire                                s_REG_DN0_FILE2_EN                      ;//(s)  [  1]
    ...
    wire                                s_REG_DN1_FILE0_EN                      ;//(s)  [  1]
    wire                                s_REG_DN1_FILE1_EN                      ;//(s)  [  1]
    wire                                s_REG_DN1_FILE2_EN                      ;//(s)  [  1]
...
/+============================================================================*/
     ...
     assign  DN0_FILE_SOF               = r_DN0_FILE_SOF                        ;
     assign  DN0_FILE_EOF               = r_DN0_FILE_EOF                        ;
     assign  DN0_FILE_VCH               = r_DN0_FILE_VCH                        ;
     assign  DN0_FILE_ADDR              = r_DN0_FILE_ADDR                       ;
     assign  DN0_FILE_SIZE              = r_DN0_FILE_SIZE                       ;

     assign  DN1_FILE_SOF               = r_DN1_FILE_SOF                        ;
     assign  DN1_FILE_EOF               = r_DN1_FILE_EOF                        ;
     assign  DN1_FILE_VCH               = r_DN1_FILE_VCH                        ;
     assign  DN1_FILE_ADDR              = r_DN1_FILE_ADDR                       ;
     assign  DN1_FILE_SIZE              = r_DN1_FILE_SIZE                       ;
...
/+============================================================================*/
    ...
    assign s_REG_DN0_FILE0_EN           = (r_REG_ADR == p_ADD_DN0_FILE0) ? 1'b1 : 1'b0 ;
    assign s_REG_DN0_FILE1_EN           = (r_REG_ADR == p_ADD_DN0_FILE1) ? 1'b1 : 1'b0 ;
    assign s_REG_DN0_FILE2_EN           = (r_REG_ADR == p_ADD_DN0_FILE2) ? 1'b1 : 1'b0 ;
    ...
    assign s_REG_DN1_FILE0_EN           = (r_REG_ADR == p_ADD_DN1_FILE0) ? 1'b1 : 1'b0 ;
    assign s_REG_DN1_FILE1_EN           = (r_REG_ADR == p_ADD_DN1_FILE1) ? 1'b1 : 1'b0 ;
    assign s_REG_DN1_FILE2_EN           = (r_REG_ADR == p_ADD_DN1_FILE2) ? 1'b1 : 1'b0 ;
...
/+============================================================================*/
    ...
    always @(posedge PCIE_CLK or posedge PCIE_RST) begin
        if (PCIE_RST) begin
            ...
            if (r_REG_WEN & s_REG_DN0_FILE0_EN)     begin  r_DN0_FILE_ADDR[31: 0]  <= r_REG_WDT[31:0] ; end
            if (r_REG_WEN & s_REG_DN0_FILE1_EN)     begin  r_DN0_FILE_SIZE[31: 0]  <= r_REG_WDT[31:0] ; end
            if (r_REG_WEN & s_REG_DN0_FILE2_EN)     begin  r_DN0_FILE_VCH          <= r_REG_WDT[15:0] ; end

            if (r_REG_WEN & s_REG_DN1_FILE0_EN)     begin  r_DN1_FILE_ADDR[31: 0]  <= r_REG_WDT[31:0] ; end
            if (r_REG_WEN & s_REG_DN1_FILE1_EN)     begin  r_DN1_FILE_SIZE[31: 0]  <= r_REG_WDT[31:0] ; end
            if (r_REG_WEN & s_REG_DN1_FILE2_EN)     begin  r_DN1_FILE_VCH          <= r_REG_WDT[15:0] ; end
        end
    end
    ...
    always @(posedge PCIE_CLK or posedge PCIE_RST) begin
        if (PCIE_RST) begin
            ...
            r_DN0_FILE_SOF          <= r_REG_WEN & s_REG_DN0_FILE2_EN & r_REG_WDT[16] ;
            r_DN0_FILE_EOF          <= r_REG_WEN & s_REG_DN0_FILE2_EN & r_REG_WDT[17] ;
            r_DN1_FILE_SOF          <= r_REG_WEN & s_REG_DN1_FILE2_EN & r_REG_WDT[16] ;
            r_DN1_FILE_EOF          <= r_REG_WEN & s_REG_DN1_FILE2_EN & r_REG_WDT[17] ;
        end
    end
...
/+============================================================================*/
    ...
    assign s_REG_RD_DATA                =
                                            ...
                                            (s_REG_DN0_FB2_EN  == 1'b1) ? { p_GND[ 7:0] ,
                                            ...
                                            (s_REG_DN1_FB2_EN  == 1'b1) ? { p_GND[ 7:0] ,
